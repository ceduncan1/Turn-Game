...
// DOM Nodes Selected
var ggHealth = (0, _jquery2['default'])('.ggHealth'); //.ggHealth is class of health span
var bgHealth = (0, _jquery2['default'])('.bgHealth'); //.bgHealth is class of health span
...
// Templates
var ggTemplate = function ggTemplate(goodGuyObj) {
  selectTemplate = '';
  _underscore2['default'].each(goodGuyObj, function () {
    selectTemplate += '\n    <div class=\'wholeSelection\'>\n      \n      <div class = \'goodGuyBox\'>\n        <div class = name>\n          ' + _goodguy2['default'].name + '\n        </div>  \n        // <div class=\'image\'><img\n        <button name=\'selectGG\'>Select <%= GoodGuy.name %></button>\n      </div>\n      </div>\n    </div>\n\n  ';
  });
};

var ggAppend = function ggAppend(obj) {
  (0, _jquery2['default'])('.ggCont').append(ggTemplate(obj));
};
